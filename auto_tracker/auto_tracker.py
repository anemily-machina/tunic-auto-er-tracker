...
roomname2savefile_long = {
	...
	"East Forest Hero's Grave":["tunic", "east_forest", "grave_path_grave", "mark", "", "unknown"],
	"Forest Grave Path Upper Exit":["tunic", "east_forest", "grave_path_upper", "mark", "", "unknown"],
	"Forest Grave Path Lower Exit":["tunic", "east_forest", "grave_path_lower", "mark", "", "unknown"],
	"Forest Grave Path Lower Entrance":["tunic", "east_forest", "forest_grave_lower", "mark", "", "unknown"],
	"Forest Grave Path Upper Entrance":["tunic", "east_forest", "forest_grave_upper", "mark", "", "unknown"],
	"Forest Guard House 2 Upper Entrance":["tunic", "east_forest", "forest_gh2_upper", "mark", "", "unknown"],
	"Forest Guard House 2 Lower Entrance":["tunic", "east_forest", "forest_gh2_lower", "mark", "", "unknown"],
	"Forest Guard House 1 Gate Entrance":["tunic", "east_forest", "forest_gh1_upper", "mark", "", "unknown"],
	"Forest to Belltower":["tunic", "east_forest", "forest_to_belltower", "mark", "", "unknown"],
	"Forest Dance Fox Outside Doorway":["tunic", "east_forest", "forest_dance_fox", "mark", "", "unknown"],
	"Forest to Far Shore":["tunic", "east_forest", "forest_portal", "mark", "", "unknown"],
	"Forest Guard House 1 Lower Entrance":["tunic", "east_forest", "forest_gh1_lower", "mark", "", "unknown"],
